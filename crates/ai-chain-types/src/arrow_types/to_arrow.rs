...
pub const AI_CHAIN_SCHEMA_KEY: &str = "ai_chain_schema";

// Maps a AIChain Schema to an Arrow Schema
...
// Maps a AIChain Record to an Arrow RecordBatch of size 1
...
// Maps the AIChain field type to the arrow data type
